                    ...
                    InkWell(
                      onTap: () async {
                        await Clipboard.setData(
                            ClipboardData(text: p.getPassword));
                      },
                      child: Icon(
                        Icons.copy,
                        size: w * 0.06,
                                ...
                                showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      ...
                                      content: const Text(
                                          'Once you delete this password you won\'t be able to recover it. Are you sure you want to delete this password?'),
                                      actions: <Widget>[
                                        TextButton(
